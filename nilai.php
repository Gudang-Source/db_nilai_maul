...
<div class="content">
  <div class="content-font">
    <center>
      <h1>Data Nilai</h1></center><hr>
      <form class="" action="nilai.php" method="post">
        Pilih Kelas - Jurusan - Mapel : <select class="" name="id_mengajar" style="width: 15%">
        ...
        <input type="submit" name="go" class="button" value="Pilih">
      </form>
      <hr>
      <?php
      if (isset($_POST['go'])) { ?>
      ...
      <?php } else echo "~ Pilih Menu Diatas ~"?>
